...
comedian_3 = Comedian.create(name: "Greg Proops", age: 59, hometown: "Phoenix")
comedian_4 = Comedian.create(name: "Colin Mochrie", age: 60, hometown: "London")
comedian_5 = Comedian.create(name: "Jim Gaffigan", age: 50, hometown: "Chicago")
comedian_6 = Comedian.create(name: "Eddie Izzard", age: 56, hometown: "London")
...
comedian_3.specials.create(title: "Live at Musso and Frank Grill", runtime: 60, image_file: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQgUbphhHPdiUIim78ObpjpFa4EAurtpN-uU8hCDRaXxbbRf06uA")
comedian_4.specials.create(title: "Not Made Up Special Name", runtime: 6, image_file: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGNQkGQY7LRF6inHp5IQbRRrkfvT9Oxk0i-cDUkX28oxIHmKin")
comedian_5.specials.create(title: "Cinco", runtime: 73, image_file: "https://m.media-amazon.com/images/M/MV5BYzM5N2YyODQtZTkyMC00ZGVhLWJmZmYtZTI3ZGM2ODAzMzA1L2ltYWdlXkEyXkFqcGdeQXVyMzcwMjcwNQ@@._V1_UX182_CR0,0,182,268_AL_.jpg")
comedian_5.specials.create(title: "Noble Ape", runtime: 90, image_file: "https://m.media-amazon.com/images/M/MV5BODAyZjM3OGMtZmY2Zi00YjM0LTlhZDYtNTZmYmM2ODQ4NTNiXkEyXkFqcGdeQXVyMzcwMjcwNQ@@._V1_UX182_CR0,0,182,268_AL_.jpg")
comedian_6.specials.create(title: "Madison Square Garden", runtime: 86, image_file: "https://m.media-amazon.com/images/M/MV5BZTBmNTNkNTktOTk5Mi00OTIzLTkxMjEtNWQ0ZmNjMjg4ZmQwXkEyXkFqcGdeQXVyMTk3NDAwMzI@._V1_UY268_CR4,0,182,268_AL_.jpg")
comedian_6.specials.create(title: "Force Majeure", runtime: 85, image_file: "https://m.media-amazon.com/images/M/MV5BMTc5NzY1ODA1OV5BMl5BanBnXkFtZTgwMDYwNTE0MzE@._V1_UY268_CR9,0,182,268_AL_.jpg")
